...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub_cmd_takeoff = n.advertise<std_msgs::Empty>("ardrone/takeoff", 10);
  ros::Publisher pub_cmd_land = n.advertise<std_msgs::Empty>("ardrone/land", 10);
  ros::Publisher pub_cmd_move = n.advertise<geometry_msgs::Twist>("cmd_vel", 10);
